    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountBuyers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountBuyers_Buyers_BuyerId",
                        column: x => x.BuyerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyTimePirce = table.Column<decimal>(type: "numeric", nullable: false),
                    BuyTimePurchasePirce = table.Column<decimal>(type: "numeric", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountBuyers_BuyerId",
