...
using HFP.Shared.Commands;
using HFP.Shared.Exceptions;
using HFP.Shared.Queries;
...
namespace HFP.Shared
{
    public static class Extensions
    {
        public static IServiceCollection AddShared(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Register MediatR
            var applicationAssembly = Assembly.Load("HFP.Application"); // Replace with your actual assembly name
            var infrastructureAssembly = Assembly.Load("HFP.Infrastructure"); // Replace with your actual assembly name
